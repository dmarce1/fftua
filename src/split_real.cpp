...
void fft_split_real(complex<T>* X, int N) {
...
template<class T>
void fft_split1_real(int N1, complex<T>* X, int N) {
	switch (N1) {
	case 4:
...
void fft_split_real(int N1, complex<double>* X, int N) {
	fft_split1_real(N1, X, N);
}

void fft_split_real(int N1, complex<fft_simd4>* X, int N) {
	fft_split1_real(N1, X, N);
}
