...
void fft_dit_real_split2(T* x, int N) {
	...
	fft_dit_real_split2(x, N / 2);
	for (int n1 = 0; n1 < N1 / 2; n1++) {
		fft_dit_real_split2(x + N / 2 + n1 * N2, N2);
	}
	const auto& W = twiddles(N);
	i0 = 0;
	i1 = i0 + N2;
	...
	if (N2 / 2) {
		...
		T0R = T0I = T1R = T1I = T2R = T2I = T3R = T3I = 0;
		T4R = T4I = T5R = T5I = T6R = T6I = T7R = T7I = 0;
		U0R = U0I = U1R = U1I = U2R = U2I = U3R = U3I = 0;
		U4R = U4I = U5R = U5I = U6R = U6I = U7R = U7I = 0;
		...
		constexpr double C1 = cos(1.0 / 8.0 * M_PI);
		constexpr double C3 = cos(3.0 / 8.0 * M_PI);
		constexpr double C5 = cos(5.0 / 8.0 * M_PI);
		constexpr double C7 = cos(7.0 / 8.0 * M_PI);
		constexpr double S1 = -sin(1.0 / 8.0 * M_PI);
		constexpr double S3 = -sin(3.0 / 8.0 * M_PI);
		constexpr double S5 = -sin(5.0 / 8.0 * M_PI);
		constexpr double S7 = -sin(7.0 / 8.0 * M_PI);
		T1R = U1R;
		T3R = U3R;
		T5R = U5R;
		T7R = U7R;
